...
export const operationsQueryKey = (reportId: string, type: OperationType | ApiOperationType) =>
...
export const operationsKeyForType = (reportId: string, type: OperationType | ApiOperationType) =>
