    ...
    items: [
      {
        ...
        segments: [
          ...
          {
            text: ' — это временной контейнер для ваших расходов, доходов и накоплений. Период можно настраивать под себя и вести удобным для вас способом. Например, добавлять период для каждого месяца и записывать в него операции, совершённые в этом месяце (рекомендую).',
          },
        ],
      },
      {
        type: 'paragraph',
        segments: [
          { text: 'На странице каждого периода есть небольшая сводка информации по нему.' },
        ],
      },
      {
        type: 'paragraph',
      ...
      },
      {
        ...
        segments: [
          {
            text: 'В периодах есть пять типов операций. Каждый по-своему влияет на баланс и капитал:',
          },
        ],
      },
      {
      ...
      },
      {
        type: 'paragraph',
        segments: [
          { text: 'Остаток внутри периода считается по формуле: ' },
          {
    ...
    items: [
      ...
      },
      {
        ...
        segments: [
          ...
          { text: '«Накопления»', to: '/accumulations', bold: true },
          {
            text: ' или появившиеся автоматически из периодов, если в периоде добавить операцию с типом ',
          },
      ...
      },
      {
        ...
        segments: [
          ...
          {
            text: ' показывает рост вашего капитала (баланс + все накопления) по месяцам. ',
          },
      ...
      },
      {
        ...
        segments: [
          ...
          {
            text: ' показывает долю каждой категории — как ручных накоплений, так и накоплений из периодов — в общем объёме сбережений.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        segments: [
          {
            text: 'В прогресс цели входят все накопления её категории: добавленные вручную и появившиеся из периодов, а снятия уменьшают результат. Прогресс виден в списке целей и в карточке накоплений на главной странице.',
          },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        segments: [
          {
            text: 'Сверху выберите периоды, которые хотите учесть — сводка пересчитается автоматически.',
          },
        ],
      },
      {
    ...
    items: [
      {
        ...
        segments: [
          ...
          {
            text: ' = стартовый баланс + все доходы − все расходы − накопления из периодов − ежедневные расходы (по всем периодам).',
          },
        ],
      },
      {
