...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        type: 'paragraph',
        text: '«Ежедневные расходы» (по желанию) — отдельная категория расходов, созданная для упрощения ведения бюджета. Вместо того, чтобы отдельно записывать каждую незначительную покупку, можно один раз в день вводить сумму таких расходов за день.',
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    items: [
      {
        type: 'paragraph',
        text: 'В разделе «Накопления» можно отслеживать свои сбережения: вклады, инвестиции, отложенные на крупную покупку суммы.',
      },
      {
        type: 'paragraph',
